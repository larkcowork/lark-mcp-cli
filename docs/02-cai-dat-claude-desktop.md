...
Các "công thức" như `morning-brief`, `inbox-zero`, `meeting-prep` **không đóng gói trong repo này** — cài thêm từ marketplace [lark-cowork-plugins](https://github.com/larkcowork/lark-cowork-plugins) để gõ lệnh ngắn (ví dụ "morning") thay vì mô tả dài. Xem [05 — Mở rộng: bộ skill Cowork](05-bo-skill-cowork.md).
