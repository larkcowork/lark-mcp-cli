...
3. **Hỏi Claude** "Liệt kê lịch hôm nay của tôi" — muốn các workflow cấp cao như "Sáng nay tôi có gì?" thì cài thêm [bộ skill Cowork (marketplace)](05-bo-skill-cowork.md)
...
| 05 | [Mở rộng: bộ skill Cowork (marketplace)](05-bo-skill-cowork.md) | Mọi user |
